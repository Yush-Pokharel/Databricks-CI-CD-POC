# DATABRICKS-CI-CD-POC

The 'DATABRICKS-CI-CD-POC' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/DATABRICKS-CI-CD-POC/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] DATABRICKS-CI-CD-POC_etl` to your workspace.
